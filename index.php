...
>>>>>>> origin/master
                ...
                <div class="container">
                    ...
                    <p class="text-left" style="padding-top:25px; font-size:18px; line-height: 28px">
                        ...
                        Celem działania fundacji jest wspieranie różnych inicjatyw dążących do wprowadzenia JOW w wyborach do Sejmu RP oraz ochrona i promocja dorobku śp. prof. Jerzego Przystawy. Więcej na temat fundacji można znaleźć na stronie internetowej <a target="_blank" href="http://fundacja.jow.pl">fundacja.jow.pl</a>
                    </p>
                    </div>
                    </div>
                    </div>
